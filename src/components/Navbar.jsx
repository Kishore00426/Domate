...
import { ShoppingCart, User, MapPin, Home, Menu, X, FileText, Calendar, Tag, Search } from 'lucide-react';
    ...
    return (
        <nav className="fixed top-6 left-1/2 -translate-x-1/2 w-[90%] max-w-6xl z-50">
            <div className="bg-white/90 backdrop-blur-md rounded-full shadow-sm border border-white/20 px-6 py-3 flex items-center justify-between transition-all duration-300 hover:shadow-md">
                ...
                {isDashboard && isAccountPage && (
                    <div className="hidden md:flex absolute left-1/2 -translate-x-1/2">
                        <div className="flex items-center gap-4">
                            <button className="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 hover:bg-gray-200 text-soft-black transition-colors font-medium text-sm">
                    ...
                    {isDashboard ? (
                        <div className="hidden md:flex items-center gap-2 ">
                            ...
                            <Link to="/account" className="flex items-center gap-3 pl-2 border-l border-gray-200 cursor-pointer hover:bg-gray-50 rounded-lg p-1 transition-colors">
                                <div className="w-9 h-9 bg-beige rounded-full flex items-center justify-center text-soft-black">
                        ...
                        <>
                            ...
                            <div className="border-t pt-2 mt-2">
                                <div className="flex items-center gap-3 p-2">
                                    <div className="w-8 h-8 bg-beige rounded-full flex items-center justify-center"><User className="w-4 h-4" /></div>
                                    <div>
