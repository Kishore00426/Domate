...
const ServiceManagement = () => {
    ...
    const handleOpenModal = (item = null) => {
        ...
        if (item) {
            setFormData({
                ...
                whatIsCovered: item.whatIsCovered || '',
                whatIsNotCovered: item.whatIsNotCovered || '',
                neededEquipment: item.neededEquipment || '',
    ...
    const handleCloseModal = () => {
        ...
        setFormData({
            ...
            neededEquipment: '', warranty: '', image: null
        });
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            data.append('neededEquipment', formData.neededEquipment);
                                ...
                                {services.map((service) => (
                                    <tr key={service._id} className="hover:bg-gray-50 transition-colors">
                                        <td className="px-6 py-4 font-medium text-soft-black flex items-center gap-3">
                                            {service.image ? (
                                                <img src={service.image} alt={service.title} className="w-8 h-8 rounded-lg object-cover bg-gray-100" />
                                            ) : (
                            ...
                            <form onSubmit={handleSubmit} className="p-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">Needed Equipment</label>
                                            <textarea
                                                name="neededEquipment"
                                                value={formData.neededEquipment}
                                                onChange={handleInputChange}
                                                rows="3"
                                                ...
                                                placeholder="Ladder, Water connection, etc."
                                            />
                                        </div>
                                    </div>
